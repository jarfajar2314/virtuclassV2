    ...
    <div class="d-flex flex-column pt-3 text-start" style="background-color: white !important;">
        ...
        <div class="p-5 rounded shadow w-75 align-self-center">
            ...
            <div class="d-grid mt-5 mb-3 align-self-center w-25">
                <button @click="editdataKelas" type="submit" name="upload" class="btn btn-block text-light"
...
export default {
    ...
    methods:{
        async editdataKelas(){
            try {
                const response = await axios.post('http://localhost:8080/api/course/create', {
